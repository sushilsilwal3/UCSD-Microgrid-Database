...
#data_in=pd.read_csv('Gilman.csv',parse_dates=['DateTime']); cal_real=1; cal_reactive=1; #Gilman Parking
#data_in=pd.read_csv('Hopkins.csv',parse_dates=['DateTime']); cal_real=0.35; cal_reactive=0.5; #Hopkins Parking
...
#data_in=pd.read_csv('PoliceDepartment.csv',parse_dates=['DateTime']); cal_real=0.4; cal_reactive=0.7; #Police Department
